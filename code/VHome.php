			...
			<div class='container' data-aos='fade-up'>
				<div class='row'>
					<div class='col-lg-12'>
						...
						<button class ='get-started-btn' id='btnToday'>Today</button>
						<button class ='get-started-btn' id='btnTomm'>Tomorrow</button>
						<button class ='get-started-btn' id='btnCurrentWeek'>Current Week</button>
						<br>
						<br>
						<table id='userTable' border='1' class ='table table-bordred table-striped'>
							<thead>
								<tr>
									<th width='16%'>Order Service Date</th>
									<th width='5%'>Order Number</th>
									<th width='10%'>Service Name</th>
									<th width='10%'>Customer Name</th>
									<th width='18%'>CustomerAddress</th>
									<th width='8%'>Contact Number</th>
									<th width='8%'>Order Status</th>
									<th width='7%'>Order Details</th>
