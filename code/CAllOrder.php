      ...
      <nav id='navbar' class='navbar order-last order-lg-0'>
        <ul>
          ...
          <li class='dropdown'><a><span>View all Services</span> <i class='bi bi-chevron-down'></i></a>
            <ul>
	      <li class='dropdown'><a href='Services.php?source=1'><span>Power Wash</span> <i class='bi bi-chevron-right'></i></a>
                <ul>
		...
		<li class='dropdown'><a href='Services.php?source=2'><span>Lawn Care</span> <i class='bi bi-chevron-right'></i></a>
                <ul>
              ...
              <li class='dropdown'><a href='Services.php?source=3'><span>Snow Cleaning</span> <i class='bi bi-chevron-right'></i></a>
                <ul>
              ...
              <li class='dropdown'><a href='Services.php?source=4'><span>Pest Control</span> <i class='bi bi-chevron-right'></i></a>
                <ul>
...
<main id='main'>
    ...
    <div class='breadcrumbs' data-aos='fade-in'>
      <div class='container'>
        ...
        <p>List of all the order placed until today. Order Status shows the current status of the order. Use Review button to review the completed orders.</p>
      </div>
    </div><!-- End Breadcrumbs -->
    ...
    <section id='about' class='about'>
      <div class='container' data-aos='fade-up'>
        ...
        <div class='row'>
	  <div class='col-lg-11'>
						<input id='CusID' type='hidden' value='".$_SESSION['CID']."'>
						
						<br>
						<br>
						<table id='userTableAll' border='1'  class ='table table-bordred table-striped' >
							<thead>
								<tr>
