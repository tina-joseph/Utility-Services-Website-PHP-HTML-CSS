...
$CatID = EXPLODE('=',$_SERVER['REQUEST_URI'])[1];
...
<main id='main'>
    ...
    <div class='breadcrumbs' data-aos='fade-in'>
      <div class='container'>
        ...
        <p>Explore the services offered by us in this category.</p>
      </div>
    </div><!-- End Breadcrumbs -->
...
// get id
$sql1 = "SELECT SerShortDesc ,SerID FROM Services where CatID = ".$CatID;
...
if (mysqli_num_rows($result) > 0) {
	...
	while($row = mysqli_fetch_assoc($result)) {
		$html = $html."<div class='col-xl-4 d-flex align-items-stretch'>
						<div class='icon-box mt-4 mt-xl-0'>
							<a href='ServiceDetails.php?source=".$row['SerID']."'>
