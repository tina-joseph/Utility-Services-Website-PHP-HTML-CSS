			...
			<div class='container' data-aos='fade-up'>
				<div class='row'>
					<div class='col-lg-11'>
						...
						<button class ='get-started-btn' id='btnYear'>This Year</button>
						<button class ='get-started-btn' id='btnMonth'>This Month</button>
						<button class ='get-started-btn' id='btnWeek'>This Week</button>
						<br>
						<br>
